import scrapy
from scrapy.items import Test1Item
import sys
...
class tieba(scrapy.Spider):
    ...
    # 填写爬取地址
    start_urls = [
        "https://tieba.baidu.com/f?kw=%E4%BD%90%E4%BB%93%E7%BB%AB%E9%9F%B3&ie=utf-8&pn=50",
    ]
    ...
    def parse(self, response):
        for line in response.xpath('//li[@class=" j_thread_list clearfix"]'):
            ...
            item['link'] =line.xpath('.//div[contains(@class,"threadlist_title pull_left j_th_tit ")]/a/@href').extract()
            yield item
